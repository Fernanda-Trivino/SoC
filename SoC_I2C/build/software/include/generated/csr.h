...
/* i2c */
#define CSR_I2C_BASE 0xe0001800L
#define CSR_I2C_RST_1_ADDR 0xe0001800L
#define CSR_I2C_RST_1_SIZE 1
static inline unsigned int i2c_rst_1_read(void) {
	unsigned int r = csr_readl(0xe0001800L);
	return r;
}
static inline void i2c_rst_1_write(unsigned int value) {
	csr_writel(value, 0xe0001800L);
}
#define CSR_I2C_I2C_RST_ADDR 0xe0001804L
#define CSR_I2C_I2C_RST_SIZE 1
static inline unsigned int i2c_I2C_rst_read(void) {
	unsigned int r = csr_readl(0xe0001804L);
	return r;
}
static inline void i2c_I2C_rst_write(unsigned int value) {
	csr_writel(value, 0xe0001804L);
}
#define CSR_I2C_PRESCALE_ADDR 0xe0001808L
#define CSR_I2C_PRESCALE_SIZE 1
static inline unsigned int i2c_prescale_read(void) {
	unsigned int r = csr_readl(0xe0001808L);
	return r;
}
static inline void i2c_prescale_write(unsigned int value) {
	csr_writel(value, 0xe0001808L);
}
#define CSR_I2C_CONTROL_ADDR 0xe000180cL
#define CSR_I2C_CONTROL_SIZE 1
static inline unsigned int i2c_control_read(void) {
	unsigned int r = csr_readl(0xe000180cL);
	return r;
}
static inline void i2c_control_write(unsigned int value) {
	csr_writel(value, 0xe000180cL);
}
#define CSR_I2C_TRANSMIT_ADDR 0xe0001810L
#define CSR_I2C_TRANSMIT_SIZE 1
static inline unsigned int i2c_transmit_read(void) {
	unsigned int r = csr_readl(0xe0001810L);
	return r;
}
static inline void i2c_transmit_write(unsigned int value) {
	csr_writel(value, 0xe0001810L);
}
#define CSR_I2C_RECEIVE_ADDR 0xe0001814L
#define CSR_I2C_RECEIVE_SIZE 1
static inline unsigned int i2c_receive_read(void) {
	unsigned int r = csr_readl(0xe0001814L);
	return r;
}
#define CSR_I2C_COMMAND_ADDR 0xe0001818L
#define CSR_I2C_COMMAND_SIZE 1
static inline unsigned int i2c_command_read(void) {
	unsigned int r = csr_readl(0xe0001818L);
	return r;
}
static inline void i2c_command_write(unsigned int value) {
	csr_writel(value, 0xe0001818L);
}
#define CSR_I2C_STATUS_ADDR 0xe000181cL
#define CSR_I2C_STATUS_SIZE 1
static inline unsigned int i2c_status_read(void) {
	unsigned int r = csr_readl(0xe000181cL);
	return r;
}
...
static inline void timer0_load_write(unsigned int value) {
	csr_writel(value, 0xe0003800L);
}
#define CSR_TIMER0_RELOAD_ADDR 0xe0003804L
...
#define CSR_TIMER0_EN_ADDR 0xe0003808L
...
#define CSR_TIMER0_UPDATE_VALUE_ADDR 0xe000380cL
